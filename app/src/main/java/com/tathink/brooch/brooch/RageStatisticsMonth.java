...
public class RageStatisticsMonth extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i = 0; i < 4; i++) {
            SMcount = dbManager.SelectStress1month(i, weeks, avgSub, max);
        ...
        ((Button)findViewById(R.id.monthbtn_left)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(weeks == -20) {
                    //1주일 간의 자료만 제공합니다.
                    Toast.makeText(RageStatisticsMonth.this, "이전 보기는 6개월간 자료를 제공합니다.", Toast.LENGTH_LONG).show();
                } else {
                    weeks -= 4;
                    Intent i = new Intent(RageStatisticsMonth.this, RageStatisticsMonth.class);
                    i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(i);
                }
            }
        ...
        ((Button)findViewById(R.id.monthbtn_right)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(weeks == 0){
                    ...
                    Toast.makeText(RageStatisticsMonth.this, "현재기준 최근 한달 그래프입니다.", Toast.LENGTH_LONG).show();
                } else {
                    weeks += 4;
                    Intent i = new Intent(RageStatisticsMonth.this, RageStatisticsMonth.class);
                    i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
